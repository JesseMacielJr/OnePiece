  ...
  const listaPersonagens = [
    {
      ...
      nome: "One Piece",
      descricao:
        "One Piece é uma série de mangá escrita e ilustrada por Eiichiro Oda. Essa grandiosa saga conta as aventuras da tripulação dos Chapéus de palha, composta por: Luffy, Zoro, Nami, Chopper, Sanji, Chopper, Robin, Franky e Brook.",
      imagem: "tripulacao.jpg",
    },
    {
      id: 1,
      nome: "Monkey D. Luffy",
